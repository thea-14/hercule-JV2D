...
## Attributions
### Assets graphiques
Tous les dessins ont été réalisés par moi-même sur [Piskel](https://www.piskelapp.com/).
### Assets sonores
...
* Son du vol de chouette: par Clusman de Freesound, [écouter ici](https://freesound.org/people/Clusman/sounds/543118/)
### Fichier `loquace.js`
Les modifications apportées au fichier `loquace.js` sont de ColinLug.
## Recours aux LLMs
Aucun code ni partie de code n'a été généré par un LLM. En revanche, ChatGPT a été utilisé de façon ponctuelle pour fixer des bugs et répondre à des questions de syntaxe.
## Contexte de développement
Ce jeu a été développé avec Kaplay, dans le cadre du cours "Développement de jeux vidéo 2D" (UNIL) donné par Loïc Cattani au semestre de printemps 2026.
